...
export const NOTIFICATION_EMAIL_TYPES = [
  ...
  { type: 'MILESTONE_REQUESTED', label: 'A new milestone is requested', category: 'Proposals & Project Management' },
  { type: 'MILESTONE_REJECTED', label: 'A milestone is rejected', category: 'Proposals & Project Management' },
  { type: 'MILESTONE_DELETED', label: 'A milestone is deleted', category: 'Proposals & Project Management' },
  { type: 'MILESTONE_COMPLETED', label: 'A milestone is marked completed', category: 'Proposals & Project Management' },
  ...
  { type: 'DELIVERABLE_CHANGES_REQUESTED', label: 'Changes requested on a deliverable', category: 'Proposals & Project Management' },
  ...
  { type: 'HIRED', label: 'You were hired on a project', category: 'Proposals & Project Management' },
  { type: 'MILESTONE_FUNDED', label: 'A milestone is funded into escrow', category: 'Proposals & Project Management' },
  { type: 'CONTRACT_TERMINATION_SCHEDULED', label: 'A contract termination is scheduled', category: 'Proposals & Project Management' },
  { type: 'CONTRACT_RESTORED', label: 'A contract is restored', category: 'Proposals & Project Management' },
  ...
  { type: 'PROJECT_REVIEW_PROMPT', label: 'A completed project is ready to review', category: 'Proposals & Project Management' },
  ...
  { type: 'BOOKING_CALL_REMINDER', label: 'Reminders before an upcoming call starts', category: '1:1 Call Bookings' },
  // Ratings & Reviews
