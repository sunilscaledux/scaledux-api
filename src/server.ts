...
import blockRoutes from './module/block/BlockRoute';
import successStoryRoutes from './module/success-story/SuccessStoryRoute';
...
app.use("/api/v1/blocked-users", blockRoutes);
