...
exports.createUserAfterOtpVerification = createUserAfterOtpVerification;
exports.userLogin = userLogin;
exports.userOtpLogin = userOtpLogin;
...
async function createUserAfterOtpVerification(data) {
    try {
...
async function userOtpLogin(identifier) {
    try {
...
function normalizeContact(email) {
