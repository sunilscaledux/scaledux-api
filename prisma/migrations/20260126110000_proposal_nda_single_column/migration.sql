-- Add single NDA JSON column (offer_expires_at + all NDA fields + nda_downloaded_at)
ALTER TABLE "scd_proposals" ADD COLUMN IF NOT EXISTS "nda" JSONB;

-- Backfill from existing columns (offer_expires_at, is_nda_signed, nda_file_link, nda_sent_at, nda_signed_at, nda_signed_file_link)
